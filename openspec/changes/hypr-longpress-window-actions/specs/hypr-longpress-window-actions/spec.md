...
The daemon SHALL spawn rofi in dmenu mode at the cursor position displaying the following actions: Close, Fullscreen, Float, Minimize, Pin, Move to Workspace 1-10.
...
- **THEN** it SHALL display: Close, Fullscreen, Float, Minimize, Pin, and Move to Workspace entries for workspaces 1 through 10
